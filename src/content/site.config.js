...
export const TOP_SKILLS = ['React', 'TypeScript', 'Spring Boot', 'Node.js', 'PostgreSQL', 'AWS']
...
export const SKILL_CATEGORIES = [
  ...
  {
    label: 'Backend',
    skills: ['Java', 'Spring Boot', 'Node.js', 'GraphQL', 'PostgreSQL', 'Redis'],
  },
  {
    label: 'Tools',
...
export const EXPERIENCE = [
  {
    ...
    tech: ['Java', 'Spring Boot', 'React', 'TypeScript', 'GraphQL', 'PostgreSQL', 'AWS', 'Docker', 'GitLab CI/CD'],
  },
  {
    ...
    tech: ['Java', 'Spring Boot', 'Angular', 'MySQL', 'Redis', 'Firebase', 'Node.js', 'REST', 'GraphQL'],
  },
]
